...
class ReliableNetworkInterface : public AbstractNetworkInterface, public TimeoutEventListener {
    ...
    public:
         ...
         */
        ReliableNetworkInterface(AbstractNetworkClient* client, int ackTimeoutInMicroSeconds, std::shared_ptr<Address> localAddress=nullptr, std::shared_ptr<Address> broadcastAddress=nullptr);
        ...
        void timerHasExpired(TimerPtr responsibleTimer);
