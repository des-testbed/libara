...
class OMNeTPacket : public ::cPacket, public ARA::Packet {
  ...
  public:
    OMNeTPacket(Address* source=NULL, Address* destination=NULL, Address* sender=NULL, char type=0, unsigned int seqNr=0, const char* payload=NULL, unsigned int payloadSize=0, unsigned int hopCount = 1);
