...
#include "tests/testAPI/mocks/testbed/TestbedRoutingTableMock.h"
...
TEST(TestbedPacketTrapTest, deleteTrappedPacketsInDestructor) {
...
TEST(TestbedPacketTrapTest, untrapDeliverablePackets) {
    ...
    AddressPtr someAddress = std::make_shared<AddressMock>("bar");
...
TEST(TestbedPacketTrapTest, packetOrderIsPreserved) {
