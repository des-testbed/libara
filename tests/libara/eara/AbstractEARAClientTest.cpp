...
TEST(AbstractEARAClientTest, initializeEnergyValues) {
    ...
    DOUBLES_EQUAL(50, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
    ...
    DOUBLES_EQUAL(53.3333333, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
    ...
    DOUBLES_EQUAL(56, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
    ...
    DOUBLES_EQUAL(40, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
}
...
TEST(AbstractEARAClientTest, newRouteDiscoveryRefreshesEnergyValues) {
    ...
    client->receivePacket(fant1, interface);
    DOUBLES_EQUAL(30, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
    ...
    client->receivePacket(fant2, interface);
    DOUBLES_EQUAL(20, client->getEnergyPercentage(routingTable->getEnergyValue(source, nextHop, interface)), 0.0001);
}
